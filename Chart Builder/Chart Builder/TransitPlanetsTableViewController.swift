...
//  hg
//
//  Created by Errick Williams on 4/4/22.
//

import UIKit
import SwissEphemeris

var TransitPlanets = Planets()
var vc = ViewController()
class TransitTableViewController: UITableViewController {
    var LD = Date()
...
//        let now = Date()
      ...
      planet9.sign_placement = "Neptune is at \(natal_neptuneSign)"
        ...
        TransitPlanets = [planet1,planet2,planet3,planet4,planet5,planet6,planet7,planet8,planet9,planet10]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let planet = TransitPlanets[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let selectedPlanet = TransitPlanets[indexPath.row]
