...
var natalPlanets = Planets()
//var vc = ViewController()

class NatalTableViewController: UITableViewController {

    var birthDate = Date(timeIntervalSince1970: 233096220.0)
...
//        let now = Date()
        ...
        // Astronomical and astrological information for the moon at this point in time.
              var LM_moonCoordinate = Coordinate<Planet>(body: .moon, date: birthDate)
        ...
        var LM_moonSign = LM_moonCoordinate.tropical.formatted
                              ...
                              var progressed_moonCoordinate = Coordinate<Planet>(body: .moon, date: birthDate)
        // The moon's longitude.
        ...
        // The speed in latitude (deg/day).
              ...
              var natal_moonCoordinate = Coordinate<Planet>(body: .moon, date: birthDate)
         // The moon's longitude.
         ...
         var natal_moonSign = natal_moonCoordinate.tropical.formatted
              ...
              var minor_natal_moonCoordinate = Coordinate<Planet>(body: .moon, date: birthDate)
         // The moon's longitude.
         ...
         var minor_natal_moonSign = minor_natal_moonCoordinate.tropical.formatted
                      ...
                      var minor_natal_moonCoordinate2 = Coordinate<Planet>(body: .moon, date: birthDate)
                 // The moon's longitude.
              ...
              var natal_sunCoordinate = Coordinate<Planet>(body: .sun, date: birthDate)
              // The moon's longitude.
        ...
        var LM_sunCoordinate = Coordinate<Planet>(body: .sun, date: birthDate)
        // The moon's longitude.
        ...
        var sunSpeed = LM_sunCoordinate.speedLongitude
              ...
              var progressed_sunCoordinate = Coordinate<Planet>(body: .sun, date: birthDate)
        // The moon's longitude.
        ...
        // The speed in latitude (deg/day).
              ...
              var minor_natal_sunCoordinate = Coordinate<Planet>(body: .sun, date: birthDate)
              // The moon's longitude.
              ...
              let natal_mercuryCoordinate = Coordinate<Planet>(body: .mercury, date: birthDate)
              // The moon's longitude.
        ...
        let LM_mercuryCoordinate = Coordinate<Planet>(body: .mercury, date: birthDate)
        // The moon's longitude.
        ...
        var LM_mercurySign = LM_mercuryCoordinate.tropical.formatted
              ...
              var progressed_mercuryCoordinate = Coordinate<Planet>(body: .mercury, date: birthDate)
        // The moon's longitude.
        ...
        // The moon's latitude.
              ...
              var minor_natal_mercuryCoordinate = Coordinate<Planet>(body: .mercury, date: birthDate)
              // The moon's longitude.
              ...
              let natal_venusCoordinate = Coordinate<Planet>(body: .venus, date: birthDate)
              // The moon's longitude.
        ...
        let LM_venusCoordinate = Coordinate<Planet>(body: .venus, date: birthDate)
        // The moon's longitude.
        ...
        var LM_venusSign = LM_venusCoordinate.tropical.formatted
              ...
              var progressed_venusCoordinate = Coordinate<Planet>(body: .venus, date: birthDate)
        // The moon's longitude.
        ...
        // The speed in latitude (deg/day).
              ...
              var minor_natal_venusCoordinate = Coordinate<Planet>(body: .venus, date: birthDate)
              // The moon's longitude.
              ...
              let natal_marsCoordinate = Coordinate<Planet>(body: .mars, date: birthDate)
              // The moon's longitude.
        ...
        let LM_marsCoordinate = Coordinate<Planet>(body: .mars, date: birthDate)
        // The moon's longitude.
        ...
        var LM_marsSign = LM_marsCoordinate.tropical.formatted
              ...
              var progressed_marsCoordinates = Coordinate<Planet>(body: .mars, date: birthDate)
        // The moon's longitude.
        ...
        // The speed in distance (AU/day).
              ...
              var minor_natal_marsCoordinate = Coordinate<Planet>(body: .mars, date: birthDate)
              // The moon's longitude.
              ...
              let natal_jupiterCoordinate = Coordinate<Planet>(body: .jupiter, date: birthDate)
              // The moon's longitude.
        ...
        let LM_jupiterCoordinate = Coordinate<Planet>(body: .jupiter, date: birthDate)
        // The moon's longitude.
        ...
        var LM_jupiterSign = LM_jupiterCoordinate.tropical.formatted
              ...
              var progressed_jupiterCoordinates = Coordinate<Planet>(body: .jupiter, date: birthDate)
        // The moon's longitude.
        ...
        var progressed_jupiterSign = progressed_jupiterCoordinates.tropical.formatted
              ...
              var minor_natal_jupiterCoordinate = Coordinate<Planet>(body: .jupiter, date: birthDate)
              // The moon's longitude.
              ...
              let natal_saturnCoordinate = Coordinate<Planet>(body: .saturn, date: birthDate)
              // The moon's longitude.
        ...
        let LM_saturnCoordinate = Coordinate<Planet>(body: .saturn, date: birthDate)
        // The moon's longitude.
        ...
        var LM_saturnSign = LM_saturnCoordinate.tropical.formatted
              ...
              var minor_natal_saturnCoordinate = Coordinate<Planet>(body: .saturn, date: birthDate)
              // The moon's longitude.
              ...
              var progressed_saturnCoordinates = Coordinate<Planet>(body: .saturn, date: birthDate)
        // The moon's longitude.
        ...
        var progressed_saturnSign = progressed_saturnCoordinates.tropical.formatted
              ...
              let natal_uranusCoordinate = Coordinate<Planet>(body: .uranus, date: birthDate)
              // The moon's longitude.
              ...
              var minor_natal_uranusCoordinate = Coordinate<Planet>(body: .uranus, date: birthDate)
              // The moon's longitude.
        ...
        let LM_uranusCoordinate = Coordinate<Planet>(body: .uranus, date: birthDate)
        // The moon's longitude.
        ...
        var LM_uranusSign = LM_uranusCoordinate.tropical.formatted
              ...
              var progressed_uranusCoordinates = Coordinate<Planet>(body: .uranus, date: birthDate)
        // The moon's longitude.
        ...
        var progressed_uranusSign = progressed_uranusCoordinates.tropical.formatted
              ...
              let natal_neptuneCoordinate = Coordinate<Planet>(body: .neptune, date: birthDate)
              // The moon's longitude.
              ...
              var minor_natal_neptuneCoordinate = Coordinate<Planet>(body: .neptune, date: birthDate)
              // The moon's longitude.
        ...
        let LM_neptuneCoordinate = Coordinate<Planet>(body: .neptune, date: birthDate)
        // The moon's longitude.
        ...
        var LM_neptuneSign = LM_neptuneCoordinate.tropical.formatted
              ...
              var progressed_neptuneCoordinate = Coordinate<Planet>(body: .neptune, date: birthDate)
        // The moon's longitude.
        ...
        var progressed_neptuneSign = progressed_neptuneCoordinate.tropical.formatted
              ...
              let natal_plutoCoordinate = Coordinate<Planet>(body: .pluto, date: birthDate)
              // The moon's longitude.
        ...
        let LM_plutoCoordinate = Coordinate<Planet>(body: .pluto, date: birthDate)
        // The moon's longitude.
        ...
        // The speed in latitude (deg/day).
              ...
              var progressed_plutoCoordinates = Coordinate<Planet>(body: .pluto, date: birthDate)
        // The moon's longitude.
        ...
        // The speed in latitude (deg/day).
              ...
              var minor_natal_plutoCoordinate = Coordinate<Planet>(body: .pluto, date: birthDate)
              // The moon's longitude.
      ...
      planet9.sign_placement = "Neptune is at \(natal_neptuneSign)"
        ...
        natalPlanets = [planet1,planet2,planet3,planet4,planet5,planet6,planet7,planet8,planet9,planet10]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let planet = natalPlanets[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let selectedPlanet = natalPlanets[indexPath.row]
